      ...
      this.HttpService.postMethods('login', params).subscribe(
        result => {
          if(result.data.code == 200){
            ...
            // localStorage.setItem('arrreport', JSON.stringify(result.data.data.user_infor['arrreport']));
            localStorage.setItem('arrsystem', JSON.stringify(result.data.data.user_infor['arrsystem']));
            // localStorage.setItem('arrSociological', JSON.stringify(result.data.data.user_infor['arrSociological']));
            // localStorage.setItem('arrSipas', JSON.stringify(result.data.data.user_infor['arrSipas']));
